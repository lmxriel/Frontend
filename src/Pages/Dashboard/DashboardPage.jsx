        ...
        <div className="flex gap-4 px-6 justify-center">
          {quickActions.map((action, idx) => (
            <button
              ...
              className="flex-1 max-w-[220px] h-12 bg-[#560705] text-white rounded-lg font-medium text-sm hover:bg-[#703736] hover:shadow-md transition-all flex items-center justify-center"
            >
              {action.label}
            </button>
          ))}
